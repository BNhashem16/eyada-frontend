      ...
      <div className="max-w-lg mx-auto pt-12 space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t('track.enterBookingNumberDesc')}</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="bookingNumber">{t('appointments.bookingNumber')}</Label>
                <Input
                  id="bookingNumber"
                  value={bookingNumber}
              ...
              <Button type="submit" className="w-full" size="lg" disabled={!bookingNumber.trim()}>
