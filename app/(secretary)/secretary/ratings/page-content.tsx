...
export function SecretaryRatingsContent() {
  ...
  const { ratings, statistics } = data || {
    ratings: [],
    statistics: { averageRating: 0, totalRatings: 0 },
  };
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          {t("secretary.ratingsPage.subtitle")}
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t("secretary.ratingsPage.performance")}
            </CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("secretary.ratingsPage.basedOnRatings")}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t("secretary.ratingsPage.reviewsDesc")}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {ratings.length === 0 ? (
