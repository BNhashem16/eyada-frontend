...
const ServiceManager = dynamic(
  () =>
    import("@/features/doctor-portal/components/service-manager").then(
      (mod) => ({ default: mod.ServiceManager }),
    ),
  {
    loading: () => (
      <Card>
...
interface ClinicManageContentProps {
  clinicId: string;
}
