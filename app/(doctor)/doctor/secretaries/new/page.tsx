...
import { useCreateSecretary, CreateSecretaryData } from '@/features/doctor-portal/hooks';
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.email && (
                <p className="text-sm text-destructive">{t('validation.emailInvalid')}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.password && (
                <p className="text-sm text-destructive">{t('validation.passwordMinLength')}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className={errors.clinicId ? 'border-destructive' : ''}>
                  <SelectValue placeholder={t('secretary.management.selectClinicPlaceholder')} />
                </SelectTrigger>
                <SelectContent>
                  {clinics?.map((clinic) => (
