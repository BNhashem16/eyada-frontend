...
export function PatientOrderDetail({ orderId }: Props) {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {order.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between md:contents">
                      ...
                      <div className="text-sm font-bold md:col-span-3 md:text-end">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                {Number(order.discountAmount) > 0 ? (
                  <div className="flex justify-between text-success-700 dark:text-success-200">
                    <span>
          ...
          {order.status === OrderStatus.PENDING ? (
            <Button
              variant="outline"
              className="w-full min-h-[44px] border-error-300 text-error-600 hover:bg-error-50 sm:min-h-10"
      ...
      {/* Cancel Dialog (responsive sheet on mobile) */}
