...
export function AdminFeedbacksList() {
  ...
  const { data: feedbacksResponse, isLoading, isError } = useAdminFeedbacks(filters);
  ...
  const getTypeLabel = (type: FeedbackType) => {
    return type === 'COMPLAINT' ? t('admin.feedbacks.complaint') : t('admin.feedbacks.suggestion');
  };
      ...
      <div className="grid gap-4 md:grid-cols-4 mb-6">
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">{t('admin.feedbacks.total')}</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">{t('admin.feedbacks.complaints')}</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">{t('admin.feedbacks.suggestions')}</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">{t('admin.feedbacks.newCount')}</p>
            ...
            <div className="flex gap-2 flex-wrap flex-1">
              ...
              >
                <SelectTrigger className="w-44">
                  <SelectValue placeholder={t('admin.feedbacks.filterByType')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">{t('admin.feedbacks.allTypes')}</SelectItem>
                  <SelectItem value="COMPLAINT">{t('admin.feedbacks.complaint')}</SelectItem>
                  <SelectItem value="SUGGESTION">{t('admin.feedbacks.suggestion')}</SelectItem>
                </SelectContent>
              </Select>
              ...
              >
                <SelectTrigger className="w-44">
                  <SelectValue placeholder={t('admin.feedbacks.filterByStatus')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">{t('admin.feedbacks.allStatuses')}</SelectItem>
                  <SelectItem value="NEW">{t('admin.feedbacks.new')}</SelectItem>
                  <SelectItem value="IN_REVIEW">{t('admin.feedbacks.inReview')}</SelectItem>
                  <SelectItem value="RESOLVED">{t('admin.feedbacks.resolved')}</SelectItem>
                  <SelectItem value="REJECTED">{t('admin.feedbacks.rejected')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
        ...
        <CardContent className="p-6">
          ...
          {feedbacks.length === 0 ? (
            <div className="text-center py-10">
              ...
              <p className="text-muted-foreground">{t('admin.feedbacks.noFeedbacks')}</p>
            </div>
          ) : (
            <>
              <Table>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedFeedback && (
                <>
                  {getTypeLabel(selectedFeedback.type)} - {selectedFeedback.name}
                </>
              )}
            </DialogDescription>
          </DialogHeader>
