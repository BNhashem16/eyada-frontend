...
export function UploadPrescriptionForm() {
  ...
  const { data: addresses } = useQuery({
    ...
    queryFn: () => apiGet<any[]>("/patients/addresses"),
  });
              ...
              {images.map((img, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-1 end-1 bg-red-500 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    <X className="h-3 w-3" />
                  </button>
                </div>
