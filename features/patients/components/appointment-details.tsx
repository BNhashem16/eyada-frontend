...
export function AppointmentDetails({ appointmentId }: AppointmentDetailsProps) {
  ...
  const { data: appointment, isLoading, isError } = usePatientAppointment(appointmentId);
    ...
    <div className="space-y-6">
          ...
          {appointment.clinic?.doctorProfile && (
            ...
            >
              <Avatar className="h-16 w-16">
                <AvatarImage src={appointment.clinic.doctorProfile.user?.profilePicture || undefined} />
          ...
          <div className="space-y-3">
              ...
              <div>
                ...
                {appointment.clinic?.city && (
                  <p className="text-sm text-muted-foreground">
                    ...
                    {appointment.clinic.city.state && ` - ${getLocalizedText(appointment.clinic.city.state.name, 'ar')}`}
                  </p>
                )}
              </div>
            </div>
            {appointment.clinic?.phoneNumber && (
              <div className="flex items-center gap-3">
                ...
                <a href={`tel:${appointment.clinic.phoneNumber}`} className="hover:text-primary-600" dir="ltr">
                  {appointment.clinic.phoneNumber}
                </a>
              </div>
            )}
      ...
      {appointment.patientNotes && (
        <Card>
          ...
          <CardContent>
            <p className="text-foreground whitespace-pre-line">{appointment.patientNotes}</p>
          </CardContent>
        </Card>
      )}
            ...
            {medicalNotes.diagnosis && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium">{t('appointments.diagnosis')}</span>
                </div>
            ...
            {medicalNotes.prescription && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium">{t('appointments.prescription')}</span>
                </div>
                <p className="text-foreground bg-muted p-3 rounded-lg whitespace-pre-line">
                  {medicalNotes.prescription}
                </p>
            ...
            {medicalNotes.notes && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium">{t('appointments.doctorNotes')}</span>
                </div>
                <p className="text-foreground bg-muted p-3 rounded-lg whitespace-pre-line">
                  {medicalNotes.notes}
                </p>
        ...
        <Card>
          ...
          <CardContent>
            ...
            {appointment.rating.review && (
              <p className="text-muted-foreground mt-2">{appointment.rating.review}</p>
            )}
          </CardContent>
        </Card>
      )}
